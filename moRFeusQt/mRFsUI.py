...
class Ui_mRFsMain(object):
    def setupUi(self, mRFsMain):
        ...
        mRFsMain.resize(400, 290)
        mRFsMain.setMinimumSize(QtCore.QSize(400, 260))
        mRFsMain.setMaximumSize(QtCore.QSize(400, 301))
        icon = QtGui.QIcon()
        ...
        self.centralwidget.setMinimumSize(QtCore.QSize(400, 260))
        self.centralwidget.setMaximumSize(QtCore.QSize(400, 260))
    ...
    def retranslateUi(self, mRFsMain):
        ...
        self.morseButton.setText(_translate("mRFsMain", "Send Msg"))
        ...
        self.readRegButton.setText(_translate("mRFsMain", "Read Reg"))
